...
var file_common_v1_common_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		Field:         72295727,
		Name:          "common.v1.http",
		Tag:           "bytes,72295727,opt,name=http",
		Filename:      "common/v1/common.proto",
	},
}
...
var (
	...
	// optional google.api.HttpRule http = 72295727;
...
var file_common_v1_common_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x18, 0xaf, 0xca, 0xbc, 0x22, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x67, 0x6f,
